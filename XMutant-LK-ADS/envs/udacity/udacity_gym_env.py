...
class UdacityGymEnv(gym.Env):
    ...
    def start_unity(self):
        ...
        self.executor = UdacitySimController(port=self.port, test_generator=self.test_generator)
    ...
    def reset(self,
        ...
        self.executor.reset(mut_info=mutation_info, skip_generation=skip_generation)
        observation, done, info = self.observe()
        return observation
    ...
    def get_track_points(self):
        return self.executor.current_track.get_control_points()
