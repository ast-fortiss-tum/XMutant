...
if __name__ == '__main__':
    ...
    while episode_count < args.num_episodes:
        ...
        while not done:
            ...
            runpath = os.path.join(time_start
                                   + '-seed=' + str(args.seed)
            ...
            if not os.path.exists(filepath + '.csv'):
                ...
                with open(filepath + '.csv', 'w', encoding='UTF8') as f:
                    ...
                    # write the header
                    writer.writerow(["episode_count", "episode_length", "img", "car_x", "car_y", "closest_cp", "speed",
                                     "cte", "is_success", "mutated_cp"])
            ...
            with open(filepath + '.csv', 'a', encoding='UTF8') as f:
                writer = csv.writer(f,
                                    ...
                                    quoting=csv.QUOTE_MINIMAL,
                                    lineterminator='\n')
                writer.writerow([episode_count, episode_length, filename, info['pos'][0], info['pos'][1], closest,
                                 speed, info['cte'], info['is_success'], mutation_point])
